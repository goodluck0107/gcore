...
// Subscribe 订阅事件
func (eb *Eventbus) Subscribe(_ context.Context, topic string, handler geventbus.EventHandler) error {
	if eb.err != nil {
		return eb.err
	}
...
// Unsubscribe 取消订阅
func (eb *Eventbus) Unsubscribe(_ context.Context, topic string, handler geventbus.EventHandler) error {
	if eb.err != nil {
		return eb.err
	}
