...
// 获取服务实体列表
func (r *Registry) services(ctx context.Context, serviceName string, waitIndex uint64, passingOnly bool) ([]*gregistry.ServiceInstance, uint64, error) {
	...
	services := make([]*gregistry.ServiceInstance, 0, len(entries))
