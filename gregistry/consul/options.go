...
func defaultOptions() *options {
	return &options{
		...
		addr:                           getc.Get(defaultAddrKey, defaultAddr).String(),
		enableHealthCheck:              getc.Get(defaultHealthCheckKey, defaultHealthCheck).Bool(),
		healthCheckInterval:            getc.Get(defaultHealthCheckIntervalKey, defaultHealthCheckInterval).Int(),
		healthCheckTimeout:             getc.Get(defaultHealthCheckTimeoutKey, defaultHealthCheckTimeout).Int(),
		enableHeartbeatCheck:           getc.Get(defaultHeartbeatCheckKey, defaultHeartbeatCheck).Bool(),
		heartbeatCheckInterval:         getc.Get(defaultHeartbeatCheckIntervalKey, defaultHeartbeatCheckInterval).Int(),
		deregisterCriticalServiceAfter: getc.Get(defaultDeregisterCriticalServiceAfterKey, defaultDeregisterCriticalServiceAfter).Int(),
	}
}
