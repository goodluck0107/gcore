...
func EncodeTriggerReq(seq uint64, event gcluster.Event, cid int64, uid ...int64) buffer.Buffer {
...
// 协议：size + header + route + seq + event + cid + [uid]
func DecodeTriggerReq(data []byte) (seq uint64, event gcluster.Event, cid int64, uid int64, err error) {
