...
func EncodeIsOnlineReq(seq uint64, kind gsession.Kind, target int64) buffer.Buffer {
...
// 协议：size + header + route + seq + session kind + target
func DecodeIsOnlineReq(data []byte) (seq uint64, kind gsession.Kind, target int64, err error) {
